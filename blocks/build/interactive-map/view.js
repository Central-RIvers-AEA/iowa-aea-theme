...
document.addEventListener('DOMContentLoaded', () => {
  ...
  fetch('/wp-json/wp/v2/district?per_page=400').then(response => response.json()).then(data => {
    districts = data;
  ...
  fetch('/wp-json/wp/v2/aea').then(response => response.json()).then(data => {
    aeaInfo = data;
